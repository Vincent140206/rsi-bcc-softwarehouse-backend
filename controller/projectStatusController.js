...
exports.updateStatus = async (req, res) => {
  try {
    ...
    console.log('🟦 Incoming updateStatus request:', { requestId, status, analyzed_by, analysis_notes });
    ...
    if (normalizedStatus === 'approved') {
      ...
      console.log('Payment not created, status not approved.');
    }
    ...
    res.status(500).json({ success: false, message: 'Gagal memperbarui status project', error });
  }
};
